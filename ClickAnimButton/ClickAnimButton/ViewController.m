...
- (void)viewDidLoad {
    ...
    LTSAnimButton *animButton1 = [[LTSAnimButton alloc]initWithFrame:CGRectMake(0, 0, 50, 50) animParams:animParams1];
    ...
    LTSAnimButton *animButton2 = [[LTSAnimButton alloc]initWithFrame:CGRectMake(0, 0, 50, 50) animParams:animParams2];
    ...
    LTSAnimButton *animButton3 = [[LTSAnimButton alloc]initWithFrame:CGRectMake(0, 0, 50, 50) animParams:animParams3];
    ...
    LTSAnimButton *animButton4 = [[LTSAnimButton alloc]initWithFrame:CGRectMake(0, 0, 50, 50) animParams:animParams4];
